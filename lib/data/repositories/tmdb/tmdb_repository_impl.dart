    ...
    try {
      ...
      final movieDetail = MovieDetail(
        ...
        images: response.images.backdrops
            .map((i) => 'https://image.tmdb.org/t/p/342${i.filePath}')
            .toList(),
      ...
      log('Error to get Movie Details', error: e, stackTrace: s);
      return Failure(DataException(message: 'Error to get Movie Details'));
    }
  }
}
